    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                Create employee profile, organizational assignment and employment information.
            </p>
        </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="employee_code"
                                    ...
                                    value="{{ old('employee_code') }}" placeholder="EMP0001">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                    value="{{ old('name')}}" placeholder="Employee Name">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="religion"
                                    ...
                                    <option value="Islam" @selected(old('religion')=='Islam' )>
                                        Islam
                                    </option>

                                    <option value="Kristen" @selected(old('religion')=='Kristen' )>
                                        Kristen
                                    </option>

                                    <option value="Katolik" @selected(old('religion')=='Katolik' )>
                                        Katolik
                                    </option>

                                    <option value="Hindu" @selected(old('religion')=='Hindu' )>
                                        Hindu
                                    </option>

                                    <option value="Buddha" @selected(old('religion')=='Buddha' )>
                                        Buddha
                                    </option>

                                    <option value="Konghucu" @selected(old('religion')=='Konghucu' )>
                                        Konghucu
                                    </option>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="position_id" id="position"
                                        ...
                                        <option value="{{ $position->id }}" @selected(old('position_id')==$position->
                                            id)>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" name="join_date"
                                    ...
                                    value="{{ old('join_date', optional(now())->format('Y-m-d')) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="employment_status"
                                    ...
                                    <option value="Permanent" @selected(old('employment_status')=='permanent' )>
                                        Permanent
                                    </option>

                                    <option value="Contract" @selected(old('employment_status')=='contract' )>
                                        Contract
                                    </option>

                                    <option value="Probation" @selected(old('employment_status')=='probation' )>
                                        Probation
                                    </option>

                                    <option value="Intern" @selected(old('employment_status')=='intern' )>
                                        Intern
                                    </option>
                ...
                <div class="card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <img id="photoPreview"
                                src="https://ui-avatars.com/api/?name=?&background=0D6EFD&color=fff&size=200"
