...
<div class="data-card position-relative">
    ...
    <div class="data-header">
        ...
        <button class="btn btn-primary" id="btnAdd">+ Add Division</button>
...
showLoading()
    $.get("{{ route('divisions.data') }}", {
        ...
        $('#statusInfo').text(
            `Showing ${res.data.length} of ${res.total} divisions`
        );
...
$('#saveBtn').click(function () {
    ...
    Swal.fire({
        title: id ? "Update division?" : "Create division?",
        ...
        let url = id ? `/divisions/${id}` : '/divisions';
...
$(document).on('click', '.editBtn', function () {
    ...
    $.get(`/divisions/${id}/edit`, function (data) {
